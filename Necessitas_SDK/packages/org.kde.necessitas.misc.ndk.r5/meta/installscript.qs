...
function Component()
{
    if( component.fromOnlineRepository )
    {
        ...
        {
            component.addDownloadableArchive( "android-ndk-r5c-linux-x86.7z" );
        }
        else if (installer.value("os") == "win")
        {
            component.addDownloadableArchive( "android-ndk-r5c-windows.7z" );
        }
        else if (installer.value("os") == "mac")
        {
            component.addDownloadableArchive( "android-ndk-r5c-darwin-x86.7z" );
        }
    }
}
