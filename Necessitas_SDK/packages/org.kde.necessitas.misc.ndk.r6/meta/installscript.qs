...
function Component()
{
    if( component.fromOnlineRepository )
    {
        ...
        {
            component.addDownloadableArchive( "android-ndk-r6-linux-x86.7z" );
        }
        else if (installer.value("os") == "win")
        {
            component.addDownloadableArchive( "android-ndk-r6-windows.7z" );
        }
        else if (installer.value("os") == "mac")
        {
            component.addDownloadableArchive( "android-ndk-r6-darwin-x86.7z" );
        }
    }
}
...
Component.prototype.createOperations = function()
{
    ...
    var gdbPath = "@TargetDir@/android-ndk-r6/toolchains/arm-linux-androideabi-4.4.3/prebuilt/";
