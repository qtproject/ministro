...
function Component()
{
    if( component.fromOnlineRepository )
    {
        ...
        {
            component.addDownloadableArchive( "android-ndk-r5c-ma-linux-x86.7z" );
        }
        else if (installer.value("os") == "win")
        {
            component.addDownloadableArchive( "android-ndk-r5c-ma-windows.7z" );
        }
        else if (installer.value("os") == "mac")
        {
            component.addDownloadableArchive( "android-ndk-r5c-ma-darwin-x86.7z" );
        }
    }
}
...
Component.prototype.createOperations = function()
{
    ...
    var gdbPath = "@TargetDir@/android-ndk-r5c/toolchains/arm-linux-androideabi-4.4.3/prebuilt/";
